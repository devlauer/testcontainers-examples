...
/**
 * Tests for {@link UserTest}. The <code>persistence.xml</code> uses the special
 * database driver {@link org.testcontainers.jdbc.ContainerDatabaseDriver} from
 * the testcontainers library. This driver will start a Docker container with a
