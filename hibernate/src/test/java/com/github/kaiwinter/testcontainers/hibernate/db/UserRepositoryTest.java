...
/**
 * Tests for {@link UserRepository}. The <code>persistence.xml</code> uses the
 * special database driver
 * {@link org.testcontainers.jdbc.ContainerDatabaseDriver} from the
 * testcontainers library. This driver will start a Docker container with a
 * MySQL database. Hibernate then creates a Persistence Unit for this
 * docker-database. The library di-instantiator is used to place the Persistence
 * Unit in the {@link UserRepository} to test its logic.
 *
 * @see {@link UserTest}
 */
public final class UserRepositoryTest {
	...
	/**
	 * Creates a new User and re-loads it by its ID. Checks the username of the
	 * original User against the loaded one from the database.
	 */
	@Test
