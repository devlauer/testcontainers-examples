...
/**
 * Tests for {@link UserRepository}. The class
 * {@link WildflyMariaDBDockerExtension} registers an arqullian observer which
 * is called on initialization time. The observer starts a Docker container with
